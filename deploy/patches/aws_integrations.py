"""
AWS-native replacements for Emergent LLM + email integrations.

Copy this file to backend/aws_integrations.py on the EC2 deploy branch,
then wire it into server.py as described in server_patch.md.
"""
