  ...
  return (
    <Layout>
      ...
      <PageHeader
        ...
        crumbs={[{ label: "Locations" }, { label: loc.name }]}
      />
        ...
        <aside className="lg:col-span-4">
          <div className="sticky top-32 space-y-4">
            ...
            <div className="rounded-3xl bg-primary text-primary-foreground p-5">
              ...
              <a href={`https://wa.me/${COMPANY.whatsapp}?text=${encodeURIComponent('Hi, I need home healthcare in ' + loc.name)}`} target="_blank" rel="noreferrer" className="btn-outline w-full mt-3 border-white/30 text-white hover:bg-white/10"><MessageCircle size={15}/> WhatsApp</a>
